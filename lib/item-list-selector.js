    ...
    _createClass(ItemListSelector, [{
        ...
        get: function get() {
            ...
            if (!this.keyword) {
                ...
                var validKeywords = this.keyword.split(' ').filter(function (text) {
                    return text;
                });
                var correctKeywords = validKeywords.map(function (keyword) {
                    return keyword.replace(/[-[\]{}()*+?.,\\^$|#\s]/g, '\\$&');
                }).join('|');
                var keywordReg = RegExp(correctKeywords, 'gi');
                return this.data.filter(function (r) {
                    return _this3.optionTemplate(r).match(keywordReg);
                });
            }
        }
        /**
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_6de5ed31_hasScoped_false_transformToRequire_video_src_poster_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_item_list_selector_vue__ = __webpack_require__(11);
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_6de5ed31_hasScoped_false_transformToRequire_video_src_poster_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_item_list_selector_vue__["a" /* default */],
...
var update = __webpack_require__(6)("532627c4", content, true, {});
...
function markMatch(text, keyword) {
    ...
    if (!keyword || !(keyword = keyword.trim())) {
        ...
        var escapedKeywords = keyword.split(' ').filter(function (text) {
            return text;
        }).map(function (text) {
