/*! @laomao800/vue-item-list-selector v1.1.0 */
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["vue-item-list-selector"] = factory(require("vue"));
	else
		root["vue-item-list-selector"] = factory(root["Vue"]);
...
var arrayFilter = __webpack_require__("2d7c"),
    ...
    baseXor = __webpack_require__("edc5"),
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules//.cache//vue-loader","cacheIdentifier":"42f024a9-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/index.vue?vue&type=template&id=2d6173c1&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"item-selector",on:{"keyup":function($event){_vm.handleKeyup($event)}}},[_c('div',{staticClass:"item-selector__searchbar"},[(_vm.keyword !== '')?_c('span',{staticClass:"item-selector__searchbar-clean",on:{"click":function($event){_vm.keyword = ''}}}):_vm._e(),_c('input',{directives:[{name:"model",rawName:"v-model.trim",value:(_vm.keyword),expression:"keyword",modifiers:{"trim":true}}],attrs:{"type":"text","placeholder":_vm.searchText},domProps:{"value":(_vm.keyword)},on:{"input":function($event){if($event.target.composing){ return; }_vm.keyword=$event.target.value.trim()},"blur":function($event){_vm.$forceUpdate()}}})]),(_vm.filtedData.length === 0)?_c('div',{staticClass:"item-selector__options--empty"},[_vm._v(_vm._s(_vm.notFoundText))]):_c('virtual-list',{key:_vm.debounceKeyword,ref:"options",staticClass:"item-selector__options-wrap",attrs:{"start":_vm.startIndex,"size":_vm.optionHeight,"remain":_vm.optionsRemain,"bench":_vm.optionsBench,"wtag":"ul","wclass":"item-selector__options"}},_vm._l((_vm.filtedData),function(item,index){return _c('li',{key:index,class:[
        'item-selector__option',
        {
          'item-selector__option--checked': _vm.isSelected(item),
          'item-selector__option--active': index === _vm.optionActiveIndex
        }
      ],domProps:{"innerHTML":_vm._s(_vm.highlightMatch(_vm.optionTemplate(item)))},on:{"click":function($event){_vm.toggleSelection(index)},"mouseenter":function($event){_vm.optionActiveIndex = index}}})}),0)],1)}
var staticRenderFns = []


// CONCATENATED MODULE: ./src/index.vue?vue&type=template&id=2d6173c1&
...
// EXTERNAL MODULE: ./node_modules/vue-virtual-scroll-list/index.js
var vue_virtual_scroll_list = __webpack_require__("95ff");
var vue_virtual_scroll_list_default = /*#__PURE__*/__webpack_require__.n(vue_virtual_scroll_list);
...
// CONCATENATED MODULE: ./src/markMatch.js
...
function markMatch(text, keyword) {
  ...
  if (!keyword || !(keyword = keyword.trim())) {
    ...
    var escapedKeywords = keyword.split(' ').filter(function (word) {
      return word;
    }).map(function (word) {
      return word.replace(/[-[\]{}()*+?.,\\^$|#\s]/g, '\\$&');
    });
    var escapedKeyword = keyword.replace(/[-[\]{}()*+?.,\\^$|#\s]/g, '\\$&');
    var keywordRegArr = escapedKeywords.length > 1 ? escapedKeywords : [];
    keywordRegArr.push(escapedKeyword);
    var reg = new RegExp(keywordRegArr.join('|'), 'gi');
    return text.toString().replace(reg, function (match) {
...
/* harmony default export */ var lib_vue_loader_options_srcvue_type_script_lang_js_ = ({
  ...
  components: {
    VirtualList: vue_virtual_scroll_list_default.a
  },
  model: {
    prop: 'selection',
  ...
  computed: {
    filtedData: function filtedData() {
      ...
      if (!keyword) {
        ...
        var validKeywords = keyword.split(' ').filter(function (text) {
          return text;
        });
        var correctKeywords = validKeywords.map(function (word) {
          return word.replace(/[-[\]{}()*+?.,\\^$|#\s]/g, '\\$&');
        }).join('|');
        var keywordReg = RegExp(correctKeywords, 'gi');
        return this.data.filter(function (r) {
          return _this.optionTemplate(r).toString().match(keywordReg);
        });
      }
    },
  ...
  methods: {
    throttleKeyword: throttle_default()(function () {
    ...
    // 匹配高亮关键字，用于筛选时生成选项
    highlightMatch: function highlightMatch(text, config) {
      return this.debounceKeyword ? markMatch(text, this.debounceKeyword, config) : text;
    },
    // 判断选项数据是否处于选中状态
    ...
    toggleSelection: function toggleSelection(index) {
      var targetIndex = typeof index === 'number' ? index : this.optionActiveIndex;
      var item = this.filtedData[targetIndex]; // istanbul ignore if
      ...
      if (!this.multiple) {
        ...
        newSelection = xor_default()(this.selectionArr, [item]);
      }

      this.syncSelection(newSelection);
    },
    syncSelection: function syncSelection(selection) {
      var newSelection = this.multiple ? selection : selection[0] || {};

      if (!isEqual_default()(newSelection, this.selection)) {
        this.$emit('selection-change', newSelection);
      }
    },
    scrollActiveOptionToView: function () {
      var _scrollActiveOptionToView = _asyncToGenerator(
      /*#__PURE__*/
      regeneratorRuntime.mark(function _callee(direction) {
        var options, option, actions, _factor;
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 2:
                options = this.$refs.options.$el;
                option = options.querySelector('.item-selector__option--active');
      ...
      function scrollActiveOptionToView(_x) {
        return _scrollActiveOptionToView.apply(this, arguments);
      }

      return scrollActiveOptionToView;
    }(),
    // 设置当前组件选项值，原有已选项会被覆盖
    setSelection: function setSelection(filterFunc) {
      // istanbul ignore if
    ...
    // 添加当前组件选项值，在原有已选项上添加
    addSelection: function addSelection(filterFunc) {
      // istanbul ignore if
      if (!this.multiple) {
        // 单选模式下无法使用本方法
        throw Error('[item-list-selector] "addSelection()" only works on multiple mode.');
      } // istanbul ignore if
      ...
      var filtedSelection = this.data.filter(filterFunc);
      var newSelection = union_default()(this.selectionArr, filtedSelection);
      this.syncSelection(newSelection);
    },
    // 在已选项中匹配命中 filterFunc 的选项
    removeSelection: function removeSelection(filterFunc) {
      // istanbul ignore if
      if (typeof filterFunc !== 'function') {
        throw Error('[item-list-selector] "removeSelection()" accept a function as argument.');
      }

      var newSelection = this.selectionArr.filter(function (item) {
